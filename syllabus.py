        ...
        "unit_2": {
            ...
            "chapters": {
                ...
                "c06": {
                    ...
                    "keywords": ["meristematic tissue", "permanent tissue", "parenchyma", "collenchyma", "sclerenchyma", "xylem", "phloem", "tracheids", "vessels", "sieve tube", "companion cell", "stomata", "guard cells", "casparian strip", "epidermal tissue", "ground tissue", "vascular bundles", "dicot root", "monocot root", "dicot stem", "monocot stem", "dicot leaf", "monocot leaf", "periderm", "secondary growth", "vascular cambium", "cork cambium", "cohesion tension theory", "cohesion-tension theory", "transpiration pull", "pressure flow hypothesis", "mass flow", "munch hypothesis", "munch pressure flow", "root pressure", "ascent of sap", "phloem loading", "phloem unloading", "sink source"],
                },
                "c07": {
        ...
        "unit_3": {
            ...
            "chapters": {
                "c08": {
                    ...
                    "keywords": ["cell theory", "schleiden", "schwann", "virchow", "prokaryotic cell", "eukaryotic cell", "plasma membrane", "fluid mosaic model", "singer nicolson", "cell wall", "osmosis", "diffusion", "plasmolysis", "turgor pressure", "endomembrane system", "endoplasmic reticulum", "golgi apparatus", "lysosome", "vacuole", "mitochondria", "cristae", "chloroplast", "ribosomes", "cytoskeleton", "cilia", "flagella", "centrosome", "nucleus", "chromosomes"],
                },
                "c09": {
        ...
        "unit_5": {
            ...
            "chapters": {
                "c16": {
                    ...
                    "keywords": ["alimentary canal", "digestion", "digestive system", "teeth", "dental formula", "stomach", "gastric glands", "pepsin", "hydrochloric acid", "hcl", "parietal cells", "intrinsic factor", "pancreas", "pancreatic juice", "trypsin", "liver", "bile", "emulsification", "small intestine", "succus entericus", "villi", "lacteals", "absorption", "kwashiorkor", "marasmus"],
                },
                "c17": {
                    "chapter_name": "Breathing and Exchange of Gases",
                    "keywords": ["respiratory system", "lungs", "alveoli", "mechanism of breathing", "inspiration", "inspiratory", "expiration", "expiratory", "respiratory volumes", "tidal volume", "vital capacity", "exchange of gases", "partial pressure", "po2", "pco2", "transport of oxygen", "oxygen dissociation curve", "bohr effect", "transport of co2", "chloride", "bicarbonate", "respiratory rhythm center", "asthma", "emphysema"],
                },
                "c18": {
                    "chapter_name": "Body Fluids and Circulation",
                    "keywords": ["blood", "plasma", "formed elements", "erythrocytes", "rbc", "leukocytes", "wbc", "platelets", "thrombocytes", "abo blood groups", "rh factor", "erythroblastosis foetalis", "blood clotting", "coagulation", "diapedesis", "lymph", "lymph node", "heart", "pericardium", "cardiac cycle", "sa node", "sinoatrial node", "pacemaker", "av node", "bundle of his", "systole", "diastole", "ecg", "double circulation", "blood pressure", "hypertension", "arteries", "veins"],
                },
                "c19": {
                    "chapter_name": "Excretory Products and Elimination",
                    "keywords": ["excretion", "excretory", "excretory system", "kidney", "nephron", "juxtaglomerular", "glomerulus", "bowman", "bowman capsule", "pct", "loop of henle", "dct", "collecting duct", "urine formation", "glomerular filtration", "gfr", "reabsorption", "tubular secretion", "counter current mechanism", "vasa recta", "raas", "renin", "angiotensin", "aldosterone", "adh", "vasopressin", "anf", "micturition", "sweat", "sweat glands", "perspiration", "urochrome", "uremia", "dialysis"],
                },
                "c20": {
                    "chapter_name": "Locomotion and Movement",
                    "keywords": ["locomotion", "movement", "muscle", "skeletal muscle", "sarcomere", "actin", "myosin", "sliding filament theory", "tropomyosin", "troponin", "sarcoplasmic reticulum", "skeletal system", "206 bones", "axial skeleton", "skull", "vertebral column", "ribs", "sternum", "appendicular skeleton", "limbs", "girdles", "joints", "synovial joints", "saddle joint", "pivot joint", "haversian", "myasthenia gravis", "tetany", "osteoporosis", "gout", "hydroxyapatite"],
                },
                "c21": {
                    "chapter_name": "Neural Control and Coordination",
                    "keywords": ["nervous system", "neuron", "axon", "dendrite", "myelin sheath", "schwann cell", "nodes of ranvier", "generation of nerve impulse", "action potential", "depolarization", "synapse", "neurotransmitter", "acetylcholine", "central nervous system", "brain", "forebrain", "cerebrum", "corpus callosum", "cerebral cortex", "white matter", "grey matter", "hypothalamus", "midbrain", "hindbrain", "cerebellum", "medulla", "spinal cord", "reflex arc", "eye", "retina", "rods", "cones", "rhodopsin", "ear", "organ of corti"],
                },
                "c22": {
        ...
        "unit_6": {
            ...
            "chapters": {
                "c23": {
                    ...
                    "keywords": ["flower", "stamen", "microsporangium", "pollen grain", "microsporogenesis", "pistil", "megasporangium", "ovule", "megasporogenesis", "embryo sac", "pollination", "anemophily", "hydrophily", "entomophily", "outbreeding devices", "pollen pistil interaction", "double fertilization", "triple fusion", "endosperm", "embryo", "seed", "tapetum", "anther", "apomixis", "polyembryony"],
                },
                "c24": {
                    "chapter_name": "Human Reproduction",
                    "keywords": ["male reproductive system", "testes", "seminiferous tubules", "sertoli cells", "leydig cells", "sperms", "spermiation", "female reproductive system", "ovaries", "graafian follicle", "fallopian tubes", "uterus", "gametogenesis", "spermatogenesis", "spermiogenesis", "oogenesis", "menstrual cycle", "follicular phase", "ovulation", "lh surge", "luteal phase", "corpus luteum", "fertilization", "acrosome", "zona pellucida", "cleavage", "blastula", "blastocyst", "implantation", "pregnancy", "placenta", "hcg", "parturition", "lactation", "colostrum"],
                },
                "c25": {
        ...
        "unit_7": {
            ...
            "chapters": {
                "c26": {
                    ...
                    "keywords": ["mendelian inheritance", "mendel laws", "law of dominance", "law of segregation", "law of independent assortment", "monohybrid cross", "dihybrid cross", "test cross", "homozygous", "heterozygous", "incomplete dominance", "codominance", "multiple alleles", "abo blood", "pleiotropy", "polygenic inheritance", "chromosomal theory of inheritance", "sutton boveri", "linkage", "recombination", "morgan", "sex determination", "mutation", "pedigree analysis", "mendelian disorders", "hemophilia", "sickle cell anemia", "phenylketonuria", "thalassemia", "chromosomal disorders", "down syndrome", "klinefelter syndrome", "turner syndrome"],
                },
                "c27": {
...
OUT_OF_SYLLABUS_DOMAINS = [
    # Physics
    "kinematics", "projectile", "quantum", "gravity", "newton law", "newtons", "thermodynamics physics", "electromagnetism", "optics ray", "optics", "optical", "prism", "refraction", "reflection light", "diffraction", "semiconductors physics", "relativity", "nuclear physics", "electric flux", "gauss law", "capacitance", "velocity", "acceleration", "friction", "moment of inertia", "magnetic field", "kirchhoff",
    # Chemistry
    "organic chemistry mechanism", "sn1", "sn2", "electrochemistry", "stoichiometry", "thermodynamics enthalpy", "enthalpy", "exothermic", "endothermic", "coordination compounds", "ligand field", "periodic table trends", "haloalkanes", "alcohols phenols ethers", "polymers chemistry", "molarity", "molality", "chemical kinetics", "equilibrium constant", "le chatelier", "redox",
    # Math
    ...
    "quadratic", "theorem", "logarithm", "polynomial", "derivation", "integral of", "determinant", "deck of cards", "playing cards", "integrate", "differential equation", "chemical bonding", "einstein", "share market", "napoleon",
    # General non-science / Programming
    "python", "javascript", "react", "programming", "coding", "java", "c++", "html", "css", "sql", "database", "algorithm",
    "movie", "celebrity", "cricket", "football", "politics", "election", "stock market", "cryptocurrency", "bitcoin", "history", "geography", "economics", "prime minister", "french revolution", "machine learning", "stock options", "operating system", "welded",
]

_DOMAIN_REGEX = re.compile(
    r"(?<!\w)(?:" + "|".join(re.escape(t) for t in sorted(OUT_OF_SYLLABUS_DOMAINS, key=len, reverse=True)) + r")(?!\w)"
)

def _domain_hit(clean: str, term: str) -> bool:
    """Boundary-aware denylist match. Lookarounds (not \b) so entries containing
    non-word characters ('c++', '3x3') can actually match."""
    return bool(re.search(r"(?<!\w)" + re.escape(term) + r"(?!\w)", clean))
...
class SyllabusValidator:
    ...
    def __init__(self, syllabus: Dict[str, Any] = OFFICIAL_SYLLABUS):
        ...
        self._single_kw_dict: Dict[str, List[Tuple[str, str, str, str]]] = defaultdict(list)
        self._multi_kw_list: List[Tuple[str, str, str, str]] = []
        for item in self.all_keywords:
            kw = item[0]
            if " " in kw:
                self._multi_kw_list.append(item)
            else:
                self._single_kw_dict[kw].append(item)
        self._generic_bio_words_set = {
    ...
    def check_query_syllabus(self, query: str) -> Dict[str, Any]:
        ...
        domain_match = _DOMAIN_REGEX.search(clean)
        if domain_match:
            return {
                "is_valid": False,
                "reason": "non_biology_domain",
                "matched_out_domain": domain_match.group(0),
        ...
        matches = []
        for t in tokens:
            if t in self._single_kw_dict:
                for kw, chap_id, chap_name, unit_name in self._single_kw_dict[t]:
                    matches.append({"keyword": kw, "chapter_id": chap_id, "chapter_name": chap_name, "unit_name": unit_name})
        for kw, chap_id, chap_name, unit_name in self._multi_kw_list:
            if kw in clean:
                matches.append({"keyword": kw, "chapter_id": chap_id, "chapter_name": chap_name, "unit_name": unit_name})

        has_generic_bio = bool(tokens & self._generic_bio_words_set) or any(
            gb in clean for gb in ("node of ranvier", "countercurrent", "sinoatrial")
        )
        ...
        # Constrained: the rare hit must ALSO belong to the Biology vocabulary
        # (concept aliases, syllabus keywords, or Biology synonym keys).
        # Otherwise ordinary words that merely occur in NCERT text
        # ('france', 'capital') would falsely validate non-biology queries.
        if not has_generic_bio and not matches:
            try:
                from concept_normalizer import concept_normalizer as _cn
                from nlp_pipeline import BIOLOGY_SYNONYMS as _syn
                _vocab = set(_cn.CONCEPT_ALIASES)
                for _kw, _, _, _ in self.all_keywords:
                    _vocab.add(_kw)
                _vocab.update(k.lower() for k in _syn)
                hits = [h for h in self._textbook_rare_hits(clean) if h in _vocab]
                if hits:
                    return {
                        "is_valid": True,
                        "confidence": "medium",
    ...
    def validate_concept_syllabus(self, concept_title: str, chapter_name: str) -> bool:
        ...
        for banned in OUT_OF_SYLLABUS_DOMAINS:
            if _domain_hit(clean_title, banned):
                return False
