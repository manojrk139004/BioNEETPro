...
class NLPPipeline:
    ...
    INTENT_PATTERNS = [
        # Explicit MCQ Request
        ("mcq_request", r"\b(mcq|mcqs|question|questions|quiz|test me|practice question|practice questions|give me \d+ questions|give me \d+ mcqs|give me \d+|give me questions)\b"),
        ...
        ("overview_explanation", r"\b(teach me about|teach me|explain|describe|tell me about|give an explanation|guide me on|discuss)\b"),
        # Formal Definitions
