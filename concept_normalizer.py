...
class BiologyConceptNormalizer:
    ...
    def __init__(self):
        ...
        self.CONCEPT_ALIASES = {
            ...
            'endoplasmic reticulum': {'canonical_name': 'Endoplasmic Reticulum', 'concept_id': 'BIO-C08-04', 'chapter_id': 'c08', 'topic': 'Cell Organelles'},
            'rer': {'canonical_name': 'Endoplasmic Reticulum', 'concept_id': 'BIO-C08-04', 'chapter_id': 'c08', 'topic': 'Cell Organelles'},
            'ser': {'canonical_name': 'Endoplasmic Reticulum', 'concept_id': 'BIO-C08-04', 'chapter_id': 'c08', 'topic': 'Cell Organelles'},
            'rough endoplasmic reticulum': {'canonical_name': 'Endoplasmic Reticulum', 'concept_id': 'BIO-C08-04', 'chapter_id': 'c08', 'topic': 'Cell Organelles'},
            'smooth endoplasmic reticulum': {'canonical_name': 'Endoplasmic Reticulum', 'concept_id': 'BIO-C08-04', 'chapter_id': 'c08', 'topic': 'Cell Organelles'},
            ...
            # NOTE: no 'cells' alias — the plural appears inside unrelated terms
            # ('Sertoli cells', 'guard cells') and hijacked their canonical concept.
            ...
            'chlorophyll': {'canonical_name': 'Chloroplasts', 'concept_id': 'BIO-C13-04', 'chapter_id': 'c13', 'topic': 'Photosynthesis'},
            ...
            'process of digestion': {'canonical_name': 'Human Digestive System', 'concept_id': 'BIO-C16-01', 'chapter_id': 'c16', 'topic': 'Digestion and Absorption'},
            'digestion': {'canonical_name': 'Human Digestive System', 'concept_id': 'BIO-C16-01', 'chapter_id': 'c16', 'topic': 'Digestion and Absorption'},
            'digestive system': {'canonical_name': 'Human Digestive System', 'concept_id': 'BIO-C16-01', 'chapter_id': 'c16', 'topic': 'Digestion and Absorption'},
            'human digestion': {'canonical_name': 'Human Digestive System', 'concept_id': 'BIO-C16-01', 'chapter_id': 'c16', 'topic': 'Digestion and Absorption'},
            ...
            'coronary artery': {'canonical_name': 'Cardiac Cycle', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Body Fluids and Circulation'},
            'coronary circulation': {'canonical_name': 'Cardiac Cycle', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Body Fluids and Circulation'},
            'bundle of his': {'canonical_name': 'Cardiac Cycle', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Body Fluids and Circulation'},
            'stomata': {'canonical_name': 'Stomata', 'concept_id': 'BIO-C06-05', 'chapter_id': 'c06', 'topic': 'Plant Anatomy'},
            'seed': {'canonical_name': 'Seed', 'concept_id': 'BIO-C05-04', 'chapter_id': 'c05', 'topic': 'Morphology of Flowering Plants'},
            'seeds': {'canonical_name': 'Seed', 'concept_id': 'BIO-C05-04', 'chapter_id': 'c05', 'topic': 'Morphology of Flowering Plants'},
            'dicot seed': {'canonical_name': 'Seed', 'concept_id': 'BIO-C05-04', 'chapter_id': 'c05', 'topic': 'Morphology of Flowering Plants'},
            'juxtaglomerular apparatus': {'canonical_name': 'Juxtaglomerular Apparatus', 'concept_id': 'BIO-C19-02', 'chapter_id': 'c19', 'topic': 'Excretory Products and their Elimination'},
            'stoma': {'canonical_name': 'Stomata', 'concept_id': 'BIO-C06-05', 'chapter_id': 'c06', 'topic': 'Plant Anatomy'},
            'guard cells': {'canonical_name': 'Stomata', 'concept_id': 'BIO-C06-05', 'chapter_id': 'c06', 'topic': 'Plant Anatomy'},
            ...
            'placenta': {'canonical_name': 'Placenta', 'concept_id': 'BIO-C24-05', 'chapter_id': 'c24', 'topic': 'Human Reproduction'},
            'corpus luteum': {'canonical_name': 'Corpus Luteum', 'concept_id': 'BIO-C24-06', 'chapter_id': 'c24', 'topic': 'Human Reproduction'},
            ...
            # Vascular tissues & Genetics (core NCERT vocabulary for retrieval anchoring)
            'xylem': {'canonical_name': 'Xylem', 'concept_id': 'BIO-C06-02', 'chapter_id': 'c06', 'topic': 'Permanent Tissues'},
            'root pressure': {'canonical_name': 'Root Pressure', 'concept_id': 'BIO-C06-07', 'chapter_id': 'c06', 'topic': 'Transport in Plants'},
            'transpiration pull': {'canonical_name': 'Root Pressure', 'concept_id': 'BIO-C06-07', 'chapter_id': 'c06', 'topic': 'Transport in Plants'},
            'phloem': {'canonical_name': 'Phloem', 'concept_id': 'BIO-C06-02', 'chapter_id': 'c06', 'topic': 'Permanent Tissues'},
            'vascular tissue': {'canonical_name': 'Xylem', 'concept_id': 'BIO-C06-02', 'chapter_id': 'c06', 'topic': 'Permanent Tissues'},
            'vascular tissues': {'canonical_name': 'Xylem', 'concept_id': 'BIO-C06-02', 'chapter_id': 'c06', 'topic': 'Permanent Tissues'},
            'genetics': {'canonical_name': 'Genetics', 'concept_id': 'BIO-C24-01', 'chapter_id': 'c24', 'topic': 'Principles of Inheritance and Variation'},
            'test cross': {'canonical_name': 'Test Cross', 'concept_id': 'BIO-C24-03', 'chapter_id': 'c24', 'topic': 'Principles of Inheritance and Variation'},
            'inheritance': {'canonical_name': 'Genetics', 'concept_id': 'BIO-C24-01', 'chapter_id': 'c24', 'topic': 'Principles of Inheritance and Variation'},
            'heredity': {'canonical_name': 'Genetics', 'concept_id': 'BIO-C24-01', 'chapter_id': 'c24', 'topic': 'Principles of Inheritance and Variation'},
            # Canonical NCERT Chapters & Core Divisions
            'animal kingdom': {'canonical_name': 'Animal Kingdom', 'concept_id': 'BIO-C04-01', 'chapter_id': 'c04', 'topic': 'Animal Kingdom'},
            'plant kingdom': {'canonical_name': 'Plant Kingdom', 'concept_id': 'BIO-C03-01', 'chapter_id': 'c03', 'topic': 'Plant Kingdom'},
            'biological classification': {'canonical_name': 'Biological Classification', 'concept_id': 'BIO-C02-01', 'chapter_id': 'c02', 'topic': 'Biological Classification'},
            'living world': {'canonical_name': 'The Living World', 'concept_id': 'BIO-C01-01', 'chapter_id': 'c01', 'topic': 'The Living World'},
            'the living world': {'canonical_name': 'The Living World', 'concept_id': 'BIO-C01-01', 'chapter_id': 'c01', 'topic': 'The Living World'},
            'photosynthesis': {'canonical_name': 'Photosynthesis', 'concept_id': 'BIO-C13-01', 'chapter_id': 'c13', 'topic': 'Photosynthesis'},
            'respiration in plants': {'canonical_name': 'Respiration', 'concept_id': 'BIO-C14-01', 'chapter_id': 'c14', 'topic': 'Respiration'},
            'plant respiration': {'canonical_name': 'Respiration', 'concept_id': 'BIO-C14-01', 'chapter_id': 'c14', 'topic': 'Respiration'},
            'cell division': {'canonical_name': 'Cell Division', 'concept_id': 'BIO-C10-01', 'chapter_id': 'c10', 'topic': 'Cell Cycle and Cell Division'},
            'cell cycle': {'canonical_name': 'Cell Division', 'concept_id': 'BIO-C10-01', 'chapter_id': 'c10', 'topic': 'Cell Cycle and Cell Division'},
            'mitosis': {'canonical_name': 'Cell Division', 'concept_id': 'BIO-C10-01', 'chapter_id': 'c10', 'topic': 'Cell Cycle and Cell Division'},
            'meiosis': {'canonical_name': 'Cell Division', 'concept_id': 'BIO-C10-01', 'chapter_id': 'c10', 'topic': 'Cell Cycle and Cell Division'},
            'human physiology': {'canonical_name': 'Human Physiology', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Human Physiology'},
            'circulation': {'canonical_name': 'Circulation', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Body Fluids and Circulation'},
            'blood circulation': {'canonical_name': 'Circulation', 'concept_id': 'BIO-C18-01', 'chapter_id': 'c18', 'topic': 'Body Fluids and Circulation'},
            'neural control': {'canonical_name': 'Neuron', 'concept_id': 'BIO-C21-01', 'chapter_id': 'c21', 'topic': 'Neural Control and Coordination'},
            'chemical coordination': {'canonical_name': 'Endocrine System', 'concept_id': 'BIO-C22-01', 'chapter_id': 'c22', 'topic': 'Chemical Coordination'},
            'endocrine system': {'canonical_name': 'Endocrine System', 'concept_id': 'BIO-C22-01', 'chapter_id': 'c22', 'topic': 'Chemical Coordination'},
            'molecular basis of inheritance': {'canonical_name': 'Molecular Basis of Inheritance', 'concept_id': 'BIO-C27-01', 'chapter_id': 'c27', 'topic': 'Molecular Basis of Inheritance'},
            'principles of inheritance': {'canonical_name': 'Genetics', 'concept_id': 'BIO-C24-01', 'chapter_id': 'c24', 'topic': 'Principles of Inheritance and Variation'},
            'evolution': {'canonical_name': 'Evolution', 'concept_id': 'BIO-C28-01', 'chapter_id': 'c28', 'topic': 'Evolution'},
            'human health': {'canonical_name': 'Human Health and Disease', 'concept_id': 'BIO-C29-01', 'chapter_id': 'c29', 'topic': 'Human Health and Disease'},
            'biotechnology': {'canonical_name': 'Biotechnology', 'concept_id': 'BIO-C31-01', 'chapter_id': 'c31', 'topic': 'Biotechnology'},
            'ecosystem': {'canonical_name': 'Ecosystem', 'concept_id': 'BIO-C34-01', 'chapter_id': 'c34', 'topic': 'Ecosystem'},
            'biodiversity': {'canonical_name': 'Biodiversity', 'concept_id': 'BIO-C35-01', 'chapter_id': 'c35', 'topic': 'Biodiversity and Conservation'},
        }

        # Common typos mapped to corrected terms
        self.TYPO_MAP = {            'mitocondria': 'mitochondria',            'mitocondrion': 'mitochondrion',
        ...
        # Ordinary English / pedagogy framing that fuzzy-matching must never
        # "correct" into biology terms (root cause, 2026-09-04: "teach" ->
        # "teeth" hijacked every "teach me ..." query into Digestion).
        self.NEVER_FUZZY_WORDS = frozenset({
            "teach", "teaches", "teaching", "learn", "learns", "learning",
            "explain", "explains", "explaining", "describe", "describes",
            "describing", "tell", "tells", "telling", "show", "shows",
            "showing", "give", "gives", "giving", "write", "writes",
            "writing", "draw", "draws", "drawing", "solve", "solves",
            "solving", "define", "defines", "defining", "compare",
            "compares", "comparing", "discuss", "discusses", "discussing",
            "summarize", "summarizes", "revise", "revises", "revision",
            "notes", "note", "steps", "step", "slowly", "briefly",
            "detail", "details", "detailed", "please", "hello", "thanks",
            "thank", "about", "with", "from", "what", "why", "how",
            "when", "which", "while", "your", "youre", "doubt", "doubts",
            "question", "questions", "answer", "answers", "asked", "asking",
            "sir", "brother", "sister", "guide", "walk", "through",
        })
    ...
    def _doc_freq(self, alias: str) -> int:
        """Number of NCERT chunks containing the alias (rarer = more specific)."""
        if BiologyConceptNormalizer._df_cache is None:
            freq: Dict[str, int] = {}
            try:
                with open(INDEX_FILE, "r", encoding="utf-8") as f:
                    chunks = json.load(f)
                for c in chunks:
                    words = set(re.findall(r"[a-z0-9]+", (c.get("section", "") + " " + c.get("text", "")).lower()))
                    for w in words:
                        freq[w] = freq.get(w, 0) + 1
            except Exception:
                pass
            BiologyConceptNormalizer._df_cache = freq
        key = alias.lower()
        return BiologyConceptNormalizer._df_cache.get(key, 0)

    def correct_typos(self, text: str) -> str:
        """Corrects known biology typos, then general edit-distance correction
        for unknown tokens (e.g. 'xyelm' -> 'xylem'). Only fires when the token
        is not already a known word and a vocabulary word is within a small
        Levenshtein distance — no per-query rules."""
        tokens = text.split()
        corrected = []
        for t in tokens:
            ...
            elif cleaned in self.NEVER_FUZZY_WORDS:
                # Pedagogy framing / ordinary English ("teach" must NEVER
                # become "teeth") — leave untouched.
                corrected.append(t)
            elif len(cleaned) >= 5:
                fix = self._fuzzy_fix(cleaned)
                corrected.append(t.lower().replace(cleaned, fix) if fix else t)
            else:
                corrected.append(t)
        return " ".join(corrected)

    _fuzzy_vocab: Optional[set] = None
    _fuzzy_cache: Optional[Dict[str, Optional[str]]] = None
    ...
    def _fuzzy_fix(self, token: str) -> Optional[str]:
        if BiologyConceptNormalizer._fuzzy_vocab is None:
            vocab = set()
            for alias in self.CONCEPT_ALIASES:
                for w in re.findall(r"[a-z]{5,}", alias.lower()):
                    vocab.add(w)
            BiologyConceptNormalizer._fuzzy_vocab = vocab
            BiologyConceptNormalizer._fuzzy_cache = {}
        cache = BiologyConceptNormalizer._fuzzy_cache
        if token in cache:
            return cache[token]
        if token in BiologyConceptNormalizer._fuzzy_vocab:
            cache[token] = None
            return None
        # Never "correct" a word the NCERT corpus actually uses
        # ('sweat' must not become 'sheath').
        try:
        ...
        cap = 3 if len(token) >= 9 else 2
        for cand in BiologyConceptNormalizer._fuzzy_vocab:
            if abs(len(cand) - len(token)) > 2:
                continue
            if cand[0] != token[0] and cand[:2] != token[:2] and cand[0] != token[1]:
                continue
            d = self._lev(token, cand, cap)
            if d > cap:
                continue
            key = (d, abs(len(cand) - len(token)), cand)
    ...
    def _precompute_aliases(self):
        self._precomputed_aliases = []
        for alias, info in self.CONCEPT_ALIASES.items():
            ...
            if alias_compact:
                self._precomputed_aliases.append((alias, alias_compact, info))
    ...
    def normalize(self, query: str) -> Dict[str, dict]:
        ...
        words = query_compact.split()
        phrases = set(words)
        for n in range(2, 5):
            for i in range(len(words) - n + 1):
                phrases.add(" ".join(words[i:i+n]))

        if not hasattr(self, "_precomputed_aliases") or not self._precomputed_aliases:
            self._precompute_aliases()

        for alias, alias_compact, info in self._precomputed_aliases:
            if alias_compact in phrases or (len(alias_compact) > 5 and alias_compact in query_compact):
                matches[alias] = info
    ...
    def get_canonical_concept_name(self, query: str) -> Optional[str]:
        ...
        Prefers multi-word matches, then the rarest (most specific) concept —
        e.g. 'glycolysis' over 'respiration' in 'glycolysis pathway in respiration'.
        """
        matches = self.normalize(query)
        if matches:
            # Prefer most specific match (multi-word concepts e.g. 'calvin cycle' over 'photosynthesis')
            max_words = max(len(a.split()) for a in matches)
            cands = [a for a in matches if len(a.split()) == max_words]
            if len(cands) == 1:
                return matches[cands[0]].get("canonical_name")
            best_alias = min(cands, key=lambda a: (self._doc_freq(a), a))
